...
namespace CryEngine.UI
{
    ...
    /// </summary>
    public class PasswordInput : Panel
    {
        /// <summary>
        /// The current content.
        /// </summary>
        ...
        public PasswordCtrl Ctrl { get; private set; }
...
namespace CryEngine.UI.Components
{
    ...
    /// </summary>
    public class PasswordCtrl : UIComponent
    {
        public const string PASSWORD_SYMBOL = "•";
        ...
        /// </summary>
        public event Action<PasswordCtrl, SubmitEventArgs> OnSubmit;
        ...
        public string Password => _password; //TODO We should encrypt this
        ...
        public override void OnKey(InputEvent e)
        {
            ...
            {
                _text.Content = new String(PASSWORD_SYMBOL[0], _contentBackup.Length);
            ...
            else if (e.KeyPressed(KeyId.Delete))
            {
                if (_cursorIndex < _text.Content.Length)
                {
                    ...
                    _password = _password.Substring(0, _cursorIndex) + _password.Substring(_cursorIndex+1);
                }
                SetCursor(true);
            }
            ...
            else if (e.KeyPressed(KeyId.Backspace))
            {
                if (_cursorIndex > 0)
                {
                    _password = _password.Substring(0, _cursorIndex - 1) + _password.Substring(_cursorIndex);
            ...
            {
                _password += e.KeyName;
                _text.Content = _text.Content.Insert(_cursorIndex, new string(PASSWORD_SYMBOL[0], e.KeyName.Length));
